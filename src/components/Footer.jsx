        ...
        <div className="footer-content">
          ...
          <div className="footer-social">
            ...
            <div className="social-links">
              <a href="www.linkedin.com/in/vishal-yadav-050b39188" target="_blank" rel="noopener noreferrer">
                <i className="fab fa-linkedin"></i>
              </a>
              <a href="https://github.com/vishal25061997" target="_blank" rel="noopener noreferrer">
                <i className="fab fa-github"></i>
              </a>
              <a href="https://VishalYadav23.artstation.com/" target="_blank" rel="noopener noreferrer">
